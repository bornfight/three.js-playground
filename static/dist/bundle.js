...
var GLTFModelControllerEnvironment = /*#__PURE__*/function () {
  ...
  _createClass(GLTFModelControllerEnvironment, [{
    ...
    value: function initFBXModel() {
      ...
      this.environment = new THREE.Mesh(new THREE.BoxBufferGeometry(100, 100, 100), new THREE.MeshPhongMaterial({
        depthWrite: false,
      ...
      this.gui.add(this.guiConf.environment, "showEnvironment").onChange(function (value) {
        _this.environment.visible = !!value;
      });
      this.gui.addColor(this.guiConf.environment, "color").onChange(function (value) {
        _this.environment.material.color.set(value);
      }); // renderer
