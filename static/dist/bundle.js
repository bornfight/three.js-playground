...
var GLTFModelController = /*#__PURE__*/function () {
  ...
  _createClass(GLTFModelController, [{
    ...
    value: function initFBXModel() {
      ...
      loader.load(model, function (model) {
        ...
        model.scene.traverse(function (object) {
          if (object.isMesh) {
            ...
            object.receiveShadow = true; // additional modifications of position, color etc.

            object.position.y = 0.1; // child.material = material;
      ...
      this.controls.autoRotateSpeed = 0.6; // handle resize
...
},{"three":"three","three/examples/jsm/controls/OrbitControls":"three/examples/jsm/controls/OrbitControls","three/examples/jsm/loaders/GLTFLoader":"three/examples/jsm/loaders/GLTFLoader"}],2:[function(require,module,exports){
"use strict";
